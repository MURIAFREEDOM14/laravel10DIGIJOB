                    ...
                    <form action="/perusahaan/isi_perusahaan_operator" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="" id="perusahaan_biodata">
                            ...
                            <div class="row mb-3 g-3 align-items-center">
                                ...
                                <div class="col-md-8">
                                    <input type="text" required value="{{$perusahaan->nama_operator}}" name="nama_operator" id="" class="form-control" aria-labelledby="passwordHelpInline">
                                </div>
                            </div>
                            <div class="row mb-3 g-3 align-items-center">
                                <div class="col-md-4">
                                ...
                                <div class="col-md-8">
                                    <input type="number" required value="{{$perusahaan->no_telp_operator}}" name="no_telp_operator" id="" class="form-control" aria-labelledby="passwordHelpInline">
                                </div>
                            </div>
                            <div class="row mb-3 g-3 align-items-center">
                                <div class="col-md-4">
                                ...
                                <div class="col-md-8">
                                    <input type="email" required value="{{$perusahaan->email_operator}}" name="email_operator" id="" class="form-control" aria-labelledby="passwordHelpInline">
                                </div>
                            </div>
                            {{-- <div class="row mb-3 g-3 align-items-center">
                                <div class="col-md-4">
                                    <label for="" class="col-form-label">Foto Operator</label>
                                </div>
                                <div class="col-md-8">
                                    @if ($perusahaan->foto_operator == "")
                                        <input type="file" required class="form-control"  name="foto_operator" value="{{$perusahaan->foto_operator}}" id="" class="form-control" aria-labelledby="passwordHelpInline" accept="image/*">                                        
                                    @elseif ($perusahaan->foto_operator !== null)
                                        ...
                                        <input type="file" class="form-control"  name="foto_operator" value="{{$perusahaan->foto_operator}}" id="" class="form-control" aria-labelledby="passwordHelpInline" accept="image/*">                                        
                                    @else
                                        <input type="file" required class="form-control"  name="foto_operator" value="{{$perusahaan->foto_operator}}" id="" class="form-control" aria-labelledby="passwordHelpInline" accept="image/*">                                        
                                    @endif
                                </div>
