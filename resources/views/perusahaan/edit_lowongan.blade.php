            ...
            <div class="card-body">
                <form action="" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-4">
                            <input type="text" name="mata_uang" value="{{$lowongan->mata_uang}}" id="" class="form-control" required>
                        </div>
                    </div>
                    <div class="row mb-3">
                        <div class="col-md-4">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-4">
                            <input type="datetime-local" name="tgl_interview" value="{{$lowongan->tgl_interview}}" class="form-control" id="">
                        </div>
                    </div>
