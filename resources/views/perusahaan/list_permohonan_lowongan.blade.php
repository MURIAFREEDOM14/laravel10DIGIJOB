                        ...
                        <div class="col-6">
                            <div class="card" style="border:1px solid green">
                                <div class="card-body">
                                    ...
                                    <div class="">
                                        <div class=" mb-1">
                                            <a class="btn btn-secondary" style="width: 100%" href="/perusahaan/lowongan_kandidat_sesuai/{{$item->id_lowongan}}">Sesuai ({{0}})</a>
                                        </div>
                                        <div class=" mb-1">
                                        ...
                                        {{-- @if () --}}
                                            {{-- <div class=" mb-1">
                                                <a class="btn btn-info" style="width: 100%" href="/perusahaan/jadwal_interview/{{$item->id_lowongan}}">Interview ({{0}})</a>
                                            </div> --}}    
                                        {{-- @endif --}}
                                        <div class=" mb-1">
