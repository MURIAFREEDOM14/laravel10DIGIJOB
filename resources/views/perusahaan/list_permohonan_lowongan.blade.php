                            ...
                            @foreach ($permohonan as $item)
                                <div class="col-md-4">
                                    <div class="card">
                                        ...
                                        <div class="card-header">
                                            <b class="float-left">{{$kandidat->nama_panggilan}}</b>
                                            <input type="text" hidden name="nama[]" value="{{$item->nama_kandidat}}" id="">                                            
                                            <b class="float-right">{{$kandidat->usia}}thn</b>
                                            <input type="text" hidden name="usia[]" value="{{$kandidat->usia}}" id="">
                                            <input type="text" hidden name="jk[]" value="{{$kandidat->jenis_kelamin}}" id="">
                                            <input type="text" hidden name="pengalaman_kerja[]" value="{{$kandidat->pengalaman_kerja}}" id="">
                                        </div>
                                        <div class="card-body">
