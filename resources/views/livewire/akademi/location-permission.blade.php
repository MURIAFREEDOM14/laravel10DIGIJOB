<div>
    ...
    <div class="row mb-3 g-3 align-items-center">
        ...
        <div class="col-md-8">
            <select wire:model.live="kota" required class="form-select" name="provinsi_perizin">
    ...
    <div class="row mb-3 g-3 align-items-center">
        ...
        <div class="col-md-8">
            <select class="form-select" required wire:model.live="kecamatan" name="kota_perizin">
                @if (!is_null($kota))
    ...
    <div class="row mb-3 g-3 align-items-center">
        ...
        <div class="col-md-8">
            <select class="form-select" required wire:model.live="kelurahan" name="kecamatan_perizin">
    ...
    <div class="row mb-3 g-3 align-items-center">
        ...
        <div class="col-md-8">
            <select class="form-select" required name="kelurahan_perizin">
