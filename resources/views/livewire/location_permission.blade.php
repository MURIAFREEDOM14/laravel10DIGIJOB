<div>
    <div class="row mb-3 g-3 align-items-center">
        ...
        <div class="col-md-8">
            <select wire:model="kota" required class="form-select" name="provinsi_perizin" id="provinsi">
    ...
    <div class="row mb-3 g-3 align-items-center">
        ...
        <div class="col-md-8">
            <select class="form-select" required wire:model="kecamatan" name="kota_perizin" id="kota">
                @if (!is_null($kota))
    ...
    <div class="row mb-3 g-3 align-items-center">
        ...
        <div class="col-md-8">
            <select class="form-select" required wire:model="kelurahan" name="kecamatan_perizin" id="kecamatan">
