                    ...
                    <form action="" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="" id="personal_biodata">
                            ...
                            <div class="row mb-3 g-3 align-items-center">
                                ...
                                <div class="col-md-8">
                                    <input type="number" placeholder="Masukkan NIK 16 digit angka" required name="nik" pattern="[0-9]{16}" id="inputPassword6" class="form-control @error('nik') is-invalid @enderror" aria-labelledby="passwordHelpInline">
                                    @error('nik')
                            ...
                            <div class="row mb-3 g-3 align-items-center">
                                ...
                                <div class="col-md-4">
                                    <input type="number" required placeholder="Masukkan RT" name="rt" id="inputPassword6" class="form-control" aria-labelledby="passwordHelpInline">
                                </div>
                                <div class="col-md-4">
                                    <input type="number" required placeholder="Masukkan RW" name="rw" id="inputPassword6" class="form-control" aria-labelledby="passwordHelpInline">
                                </div>
                            </div>
                            <div class="row mb-3 g-3 align-items-center">
                                <div class="col-md-4">
