                            ...
                            @if ($kandidat->stats_nikah == "Cerai hidup")
                                ...
                                <div class="" id="punya_anak">
                                    <div class="row mb-3 g-3 align-items-center">
                                        ...
                                        <div class="col-md-2">
                                            <input type="number" disabled value="{{$kandidat->jml_anak_lk}}" name="jml_anak_lk" id="inputPassword6" class="form-control" aria-labelledby="passwordHelpInline">
                                        </div>
                                    </div>
                                    <div class="row mb-3 g-3 align-items-center">
                                        <div class="col-md-4">
                                        ...
                                        <div class="col-md-8">
                                            ...
                                            <input type="text" disabled value="{{$kandidat->umur_angka_lk}}" name="umur_anak_lk" id="inputPassword6" class="form-control" aria-labelledby="passwordHelpInline">
                                        </div>
                                    </div>
                                    <div class="row mb-3 g-3 align-items-center">
                                        <div class="col-md-4">
                                        ...
                                        <div class="col-md-2">
                                            <input type="number" disabled value="{{$kandidat->jml_anak_pr}}" name="jml_anak_pr" id="inputPassword6" class="form-control" aria-labelledby="passwordHelpInline">
                                        </div>
                                    </div>
                                    <div class="row mb-3 g-3 align-items-center">
                                        <div class="col-md-4">
                                        ...
                                        <div class="col-md-8">
                                            <small class="col">Tuliskan umur anak dari paling besar sampai paling kecil, Contoh: 15, 12, 10, dst</small>
                                            <input type="text" disabled value="{{$kandidat->umur_anak_pr}}" name="umur_anak_pr" id="inputPassword6" class="form-control" aria-labelledby="passwordHelpInline">
                                        </div>
                                    </div>
                                </div>
                                <div class="row mb-3 g-3 align-items-center">
