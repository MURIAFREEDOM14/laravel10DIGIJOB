                    ...
                    <form action="" method="POST">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="mb-3">
                                    <label for="exampleInputPassword1">Masukkan No. Telp</label>
                                    <input name="no_telp" type="number" class="form-control" value="{{old('email')}}" required id="exampleInputPassword1">
                                </div>
                            </div>
                        </div>
                        <div class="mt-3">
