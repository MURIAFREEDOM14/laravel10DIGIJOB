                ...
                <div class="card-body">
                    <form action="" method="POST">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="mb-3">
                                    <label for="exampleInputPassword1">Masukkan Nama Akademi</label>
                                ...
                                <div class="mb-3">
                                    <label for="exampleInputPassword1">Masukkan No. NIS</label>
                                    <input name="no_nis" type="number" class="form-control" value="{{old('email')}}" required id="exampleInputPassword1">
                                </div>
                            </div>
                        </div>
                        <div class="mt-3">
